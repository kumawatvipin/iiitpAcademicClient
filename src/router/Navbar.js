...
function Navbar() {
  ...
  return (
    <div className="max-w-[1200px] z-50 mx-auto overflow-hidden flex justify-evenly items-center   ">
      <div>
        <a href="#">
      ...
      <div>
        {AA ? (
          <Link
            to="/logout"
            className="font-mullish bg-green-500 rounded-sm p-2  hover:bg-green-400 transition-all duration-300 text-white   text-2xl"
          >
            {" "}
            Logout{" "}
          </Link>
